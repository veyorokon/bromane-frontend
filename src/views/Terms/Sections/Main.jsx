    ...
    return (
      ...
      >
        <S.TitleWrapper color="black.0" alignItems="center" p={"5% 10% 5% 10%"}>
          <Title textAlign="left">Terms Of Service</Title>
        </S.TitleWrapper>
        <SubTitle textAlign="center">
          These terms and conditions outline the rules and regulations for the
          use of bromane.com{"'"}s website.
        </SubTitle>
        <br />{" "}
        ...
        <Text pt="5px">
          ...
          conditions in full.Do not continue to use bromane.com 's website if
        ...
        <Text pt="5px">
          {" "}
          We employ the use of cookies.By using bromane.com 's website you
          consent to the use of cookies in accordance with bromane.com 's
          privacy policy.
        </Text>
        <Text pt="5px">
          Most of the modern day interactive web sites use cookies to enable us
          to retrieve user details for each visit.Cookies are used in some areas
          of our site to enable the functionality of this area and ease of use
          for those people visiting.Some of our affiliate / advertising partners
          may also use cookies.{" "}
        </Text>
        <SubTitle>License</SubTitle>
        <Text pt="5px">
          {" "}
          Unless otherwise stated, bromane.com and / or it 's licensors own the
          intellectual property rights for all material on bromane.com.All
          intellectual property rights are reserved.You may view and / or print
          pages from https: //bromane.com for your own personal use subject to
          restrictions set in these terms and conditions.
        </Text>
        <Text pt="5px"> You must not: </Text>{" "}
        <ol>
          <li> Republish material from https: //bromane.com</li>
          <li>
            {" "}
            Sell, rent or sub - license material from https: //bromane.com
          </li>
          <li>
            {" "}
            Reproduce, duplicate or copy material from https: //bromane.com
          </li>
        </ol>{" "}
        <Text pt="5px">
          {" "}
          Redistribute content from bromane.com(unless content is specifically
        ...
        <Text pt="5px">
          ...
          as work - at - home opportunities, shall not be allowed to link); (b)
          the organization does not have an unsatisfactory record with us; (c)
          the benefit to us from the visibility associated with the hyperlink
          outweighs the absence of Bromane; and(d) where the link is in the
        ...
        <Text pt="5px">
          {" "}
          No use of bromane.com 's logo or other artwork will be allowed for
        ...
        <Text pt="5px">
          ...
          on any page on your Web site or within any context containing content
          or materials that may be interpreted as libelous, obscene or criminal,
